...
const Profile = ({ user, profileOpened, onRouteChange }) => {
    ...
    return (
        <div className="w-full h-full absolute bg-gray-400 flex justify-center align-middle place-items-center">
            ...
            <div id="delete" className="absolute md:w-5/12 sm:w-full rounded-lg shadow-lg bg-white my-3" style={{visibility: 'hidden'}}>
                    <div className="flex justify-between border-b border-gray-100 px-5 py-4">
                        <div>
                    <i className="fa fa-exclamation-triangle text-orange-500"></i>
